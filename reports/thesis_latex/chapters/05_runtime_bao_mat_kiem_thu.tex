...
\begin{tabularx}{\linewidth}{R{2.9cm}R{3.6cm}Y}
\toprule
\textbf{Đe dọa} & \textbf{Tác động} & \textbf{Cơ chế phòng vệ trong thiết kế thí nghiệm} \\
\midrule
...
\setlength{\tabcolsep}{4pt}
\renewcommand{\arraystretch}{1.18}
\begin{tabularx}{\linewidth}{R{3.1cm}R{4.0cm}Y}
\toprule
\textbf{Kịch bản} & \textbf{Dữ liệu kiểm thử} & \textbf{Kết quả mong đợi} \\
\midrule
